...
The code that we uploaded wil make your entire ledstrip go on and start with the color green than after 4000 milliseconds change to red than after 4000 milliseconds again the leds will change to blue and blink 50 times. after this the code will loop and start again.
